...
在藝術觀念上，夏陽主張藝術應回應當代生活經驗，而非僅停留於形式探索。他以自由而幽默的創作態度，打破抽象與具象的界線，反映對文化、社會與人性狀態的深層關注。作為臺灣現代藝術的重要推手，夏陽不僅以作品奠定其歷史地位，也為戰後臺灣藝術開拓了更為開放與多元的創作視野。`
...

  {
    ...
    detail: { intro: `【這裡貼：Anthony Gormley 的詳細內容】` }
  },
...

  {
    ...
    role: "1952－",
    keywords: ["後極簡主義", "身體政治"],
    cardBio: "美國重要的當代女性雕塑藝術家，以探討身體、心理狀態與存在焦慮聞名。",
    image: "images/artists/Rona-Pondick.jpg",
    detail: { intro: `【這裡貼：Rona Pondick 的詳細內容】` }
  },

  {
    ...
    detail: { intro: `【這裡貼：Louise Bourgeois 的詳細內容】` }
  },

  {
    ...
    detail: { intro: `【這裡貼：Frederic Fontenoy 的詳細內容】` }
  },

  {
    ...
    role: "1984－",
    keywords: ["超現實", "解讀情感"],
    cardBio: "作品融合超現實、細膩技法與心理深度，形成極具辨識度的肖像語言。",
    image: "images/artists/Henrietta-Harris.jpg",
    detail: { intro: `【這裡貼：Henrietta Harris 的詳細內容】` }
  }
];
